    ...
    <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item banner_img <?php echo $index === 0 ? 'active' : ''; ?>">
                <img class="w-100 img-banner" src="<?php echo esc_url($img_url); ?>"
...
<div class="container-fluid service pt-6 ">
    <div class="container">
        ...
        <div class="btn-more">
            <a class="btn btn-light px-3 absolute" href="<?php echo get_permalink(get_page_by_path('tin-tuc')); ?>"
                style="bottom: 20px; right: 20px;">
                Xem thêm<i class="bi bi-chevron-double-right ms-1"></i>
            </a>
        </div>
    </div>
</div>
...
<!-- Appoinment Start -->
<div class="container-fluid mt-6  py-5 wow fadeIn"
...
<div class="container-fluid team pt-6 ">
    <div class="container">
        <div class="text-center mx-auto wow fadeInUp relative" data-wow-delay="0.1s" style="max-width: 600px;">
        ...
        <div class="row g-4">
            ...
            wp_reset_postdata(); ?>
            <div class="btn-more">
                <a class="btn btn-light px-3 absolute"
                    href="<?php echo get_permalink(get_page_by_path('thanh-vien')); ?>"
                    style="bottom: 20px; right: 20px;">
                    Xem thêm<i class="bi bi-chevron-double-right ms-1"></i>
                </a>
            </div>
